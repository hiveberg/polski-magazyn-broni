...
const schema = z.object({ entityType: z.enum(["WeaponRegisterEntry", "AmmunitionRegisterEntry"]), entryId: z.string().min(1), correctedValues: z.record(z.string(), z.unknown()), reason: z.string().trim().min(5).max(1000), pin: pinSchema });
