...
export default async function ChangePasswordPage() {
  ...
  return <main className="auth-page"><section className="auth-card"><header className="auth-banner"><h1>Ustaw własne hasło</h1><p>Hasło jednorazowe nie może służyć do normalnej pracy.</p></header><div className="auth-body"><ChangePasswordForm needsPin={!current?.pinHash} /><p className="auth-branding">Dane są przechowywane wyłącznie w tej instalacji.</p></div></section></main>;
}
