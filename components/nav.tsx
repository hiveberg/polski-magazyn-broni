...
import { Archive, ArrowDownToLine, ArrowUpFromLine, BookOpen, Boxes, FilePlus2, Files, Gauge, History, PackageCheck, Printer, Settings, ShieldCheck, Users } from "lucide-react";

const sections = [
  { title: "PULPIT", items: [["Pulpit", "/dashboard", Gauge]] },
